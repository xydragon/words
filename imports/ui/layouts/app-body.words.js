...
import './app-body.words.html';
import './app-sidebar.html';
...
Template.App_words_body.onCreated(function appBodyOnCreated() {
...
Template.App_words_body.helpers({
  menuOpen() {
...
Template.App_words_body.events({
